...
class fit(object):
    ...
    def plot_sfh_posterior(self, show=False, save=True, log_x=False, log_y=False, mean=False, from_bigbang=False, colorscheme="bw"):
        return plotting.plot_sfh_posterior(self, show, save, log_x, log_y, mean, from_bigbang, colorscheme)
